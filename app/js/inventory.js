(function initInventoryPage() {
  ...
  async function openScanner(){el.scanPayload.value="";openModal(el.scanModal);if(window.ProCalAndroidShell&&typeof window.ProCalAndroidShell.startInventoryQrScan==="function"){window.ProCalAndroidShell.startInventoryQrScan();return;}await startBrowserCamera();}
