...
const PERMISSION_TEXTS = {
  ...
  "attendance.read_self": { bg: "Присъствия (само мои)", desc: "Вижда собствения си дневник на присъствията." },
  "attendance.punch": { bg: "Отбелязва присъствие", desc: "Записва пристигане и тръгване през уеб или NFC." },
  "attendance.read_all": { bg: "Присъствия (всички)", desc: "Вижда дневника на всички потребители." },
  "attendance.manage": { bg: "Управлява присъствия", desc: "Коригира записи и управлява NFC станции." },
  "inventory.read": { bg: "Склад: преглед", desc: "Вижда артикули, наличности и движения." },
  "inventory.receive": { bg: "Склад: приемане", desc: "Добавя получени количества в склада." },
  "inventory.issue": { bg: "Склад: изписване", desc: "Изписва налични количества от склада." },
  "inventory.transfer": { bg: "Склад: преместване", desc: "Премества наличности между локации." },
  "inventory.count": { bg: "Склад: корекции", desc: "Прави инвентаризационни корекции и обръща движения." },
  "inventory.items.manage": { bg: "Склад: артикули и локации", desc: "Създава и редактира артикули, QR кодове и складови локации." },
  "inventory.settings.manage": { bg: "Склад: настройки", desc: "Управлява праговете и получателите на складови известия." },
  "inventory.reports": { bg: "Склад: отчети", desc: "Има достъп до складови справки и експорти." },
