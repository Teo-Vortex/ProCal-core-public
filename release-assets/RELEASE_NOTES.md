## ProCal Core Public v0.9.9-beta.4

This release includes the self-hosted Core application, one-click container updates, improved profile and mobile links, and the signed ProCal Android application.
